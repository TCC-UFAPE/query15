# Query11 - Análise Completa de Vulnerabilidades do ffmpeg

## Descrição

A **Query11** é um script Python que combina as funcionalidades das queries 7 e 10 para realizar uma análise abrangente das vulnerabilidades do projeto **ffmpeg**, integrando dados de documentação com informações detalhadas dos commits do GitHub.
...
| Coluna | Descrição |
|--------|-----------|
| Projeto | Nome do projeto (ffmpeg) |
...
2. **Filtra vulnerabilidades** do ffmpeg
...
- ✅ **Análise focada** no projeto ffmpeg
